...
rule get_resources:
    ...
    shell:
        ...
        #"aws s3 cp s3://broad-references/hg38/v0/scattered_calling_intervals/ resources/ --recursive --no-sign-request" # this is the correct source but is missing an interval
